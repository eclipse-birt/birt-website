...
module.exports = {
  someSidebar: {
    ...
    Documentation: ['t_brief-editor-tour','t_grids','t_data-sources','t_data-sets','t_data-properties','t_cascading-styles','t_create-a-report','t_styles','t_tables','t_testing-reports','t_text-item','t_tools','t_visual-properties','report-generation'],
